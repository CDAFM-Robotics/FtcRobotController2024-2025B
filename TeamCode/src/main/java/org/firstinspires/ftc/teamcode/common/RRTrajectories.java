 ...
 */
    ...
    leftStartToNet = drive.actionBuilder(new Pose2d(-39, -65, Math.PI / 2))
      .strafeToSplineHeading(new Vector2d(-62, -50), Math.PI / 2)
      .build();

    netToFirstYellowSample = drive.actionBuilder(new Pose2d(-62, -50, Math.PI /2))
      .strafeToSplineHeading(new Vector2d(-47.5, -50), Math.PI / 2)
      .build();

    firstYellowSampleToNet = drive.actionBuilder(new Pose2d(-47.5, -50, Math.PI / 2))
      .strafeToSplineHeading(new Vector2d(-62, -50), Math.PI / 2)
      .build();

    netToSecondYellowSample = drive.actionBuilder(new Pose2d(-62, -50, Math.PI / 2))
      .strafeToSplineHeading(new Vector2d(-57.5, -50), Math.PI / 2)
      .build();

    secondYellowSampleToNet = drive.actionBuilder(new Pose2d(-57.5, -50, Math.PI / 2))
      .strafeToSplineHeading(new Vector2d(-62, -50), Math.PI / 2)
      .build();

    netToThirdYellowSampleWall = drive.actionBuilder(new Pose2d(-62, -50, Math.PI / 2))
